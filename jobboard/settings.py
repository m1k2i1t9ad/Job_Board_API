...
SECRET_KEY = "django-insecure-kv%c-6ru!125nj&wihm35-4z$m1tlwys&d3-4n+nkwm!gkxsp&"
...
INSTALLED_APPS = [
    ...
    'jobs',  # App for job listings and applications
    'users',  # App for user profiles and authentication
]
